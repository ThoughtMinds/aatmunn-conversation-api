...
api_router.include_router(
    navigation_intents.router, prefix="/navigation_intents", tags=["navigation_intents"]
)
api_router.include_router(navigation.router, prefix="/navigation", tags=["navigation"])
api_router.include_router(
    summarization.router, prefix="/summarization", tags=["summarization"]
)
api_router.include_router(
    task_execution.router, prefix="/task_execution", tags=["task_execution"]
)
api_router.include_router(
